...
To curb this trend, we suggest using the keyword `"FAIR theory"` for all resources that constitute or reference a FAIR theory. <!-- this is problematic because many search engine will tear apart this term and interpret it as two keywords - I think we need a single word without space FAIRtheory maybe -->
