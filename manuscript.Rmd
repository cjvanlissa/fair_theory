...
```{r figecs, eval = TRUE, fig.cap='Three implementations of the "empirical cycle".'}
...
<!-- ``` -->
Many have argued that observation is theory-laden, and as such, involves induction [@brewerTheoryLadennessObservationTheoryLadenness2001].
...
Finally, FAIR theory holds substantial potential for science communication. While the general public is ill-equipped to read and derive actionable insight from large quantities of empirical papers about a particular phenomenon,
theories encapsulate the bigger picture of contemporary scientific understanding.
