...
The equally critical inductive processes of theory construction and theory improvement have been largely overlooked^[We use induction to describe inferences from specific observations to general theories; others have coined *abduction* to describe "inference to the best explanation" [@peirceCollectedPapersCharles1960]. However, Peirce also acknowledged that abduction "is not essentially different from induction" (p.4881). Defining what makes a theory "best" requires making auxiliary assumptions. For present purposes, induction and abduction are interchangeable terms.].
...
Zenodo stands out in this respect, and it is in turn [indexed by Google Scholar](https://support.zenodo.org/help/en-gb/29-indexing/61-is-zenodo-indexed-by-google-scholar), Google Dataset Search, and other services.
...
formalization,
and explicit cross-references to relevant resources (papers, ontologies, macro-theories, measurement instruments, experimental designs) [@langeChecklist2025].
