...
The equally critical inductive processes of theory construction and improvement have been largely overlooked^[Here, we use "induction" to refer to inferences from specific observations to general theories. Others have used the term "abduction" to describe "inference to the best explanation" [@peirceCollectedPapersCharles1960]. For present purposes, the terms are interchangeable.].
...
<!-- ``` -->
For example, observation is theory-laden, and thus involves induction [@brewerTheoryLadennessObservationTheoryLadenness2001].
...
This vignette also shows the `theorytools` package's functionality for generating scripts for simulation studies, based on the information about distributions and functional form encoded in the aDAG.
...
Another vignette describes how to take the Dunning-Krüger effect and [specify it as a FAIR mathematical formula](https://cjvanlissa.github.io/theorytools/articles/dunning_krueger.html) [@feldEstimatingRelationshipSkill2017].
