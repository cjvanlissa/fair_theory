...
Furthermore, it is important to acknowledge that interoperability is subject to the *indeterminacy of translation* [@quineReasonsIndeterminacyTranslation1970],
...
The Kuhnian notion of "normal science" conducted within the context of a shared paradigm may provide sufficient shared background knowledge for mutual understanding [@kuhnStructureScientificRevolutions2009].
From a pragmatic perspective, these considerations indicate that,
when striving to make theory interoperable,
it is important to be as explicit as possible (e.g., about assumptions  and ontological definitions),
while acknowledging that interoperability exists on a spectrum,
