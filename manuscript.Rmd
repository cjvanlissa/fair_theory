...
<!-- R-users can use the following code (see the package documentation for more information): -->
...
<!-- fair_theory(path = "directory/for/theory", -->
<!--             title = "The Theory's Title", -->
<!--             theory_file = "path_to_existing_theory.txt", -->
<!--             remote_repo = "github_repo_name", -->
<!--             add_license = "cc0") -->
<!-- ``` -->
...
## Comparing Implementations of a Theory
