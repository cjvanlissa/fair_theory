...
However, recent reviews show that most preregistered hypotheses tests are not supported by empirical evidence [@scheelExcessPositiveResults2021].
...
One main concern is that theories lack or  *formalization* [@szollosiArrestedTheoryDevelopment2021].
...
<!-- I think it would be nice if links are colored (blue), so people can see in the PDF that there is something to click. -->
...
accelerating cumulative knowledge acquisition in psychology, other social sciences, and beyond.
