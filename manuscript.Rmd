...
The equally critical inductive processes of theory construction and theory improvement have been largely overlooked^[We use induction to describe inferences from specific observations to general theories. This is a more general interpretation than enumerative induction where a general conclusion (e.g., all swans are white) is drawn from a limited set of observations (e.g., the *n* observed white swans). Another term is *abduction*, which is used to describe the logical process of proposing explanatory propositions that make the observations unsurprising or "follow as a matter of course" [@peirceCollectedPapersCharles1960]. We decided to use the term induction, because this is what most psychologists are familiar with. We also note that Peirce acknowledged that abduction "is not essentially different from induction" (p.4881). Thus, for present purposes, induction and abduction are interchangeable terms.].
...
Making theories Findable would allow researchers to easily identify relevant theories <!-- NvD: for hypothesis derivation --> <!-- NvD: "to inform their hypotheses" reads a bit like they already have hypotheses and go for a "post-hoc search" to justify them -->,
...
For example, predator-prey models have inspired theories of <!-- NvD: intelligence (van der maas et al. 2006 https://doi.org/10.1037/0033-295x.113.4.842)-->, and the Eysenck model of atomic magnetism has inspired a network theory of depression.
...
Similarly, <!-- NvD: van Dongen and colleagues are working on a database of models and formalized theories  PREPRINT will be uploaded soon, I hope. -->
...
This property of good theories has been dubbed "discursive survival [...], the ability to be understood" [@guestWhatMakesGood2024]. <!-- NvD: I suggest keeping this -->
At present, psychological theories are often ambiguous, rendering them difficult to understand [@frankenhuisStrategicAmbiguitySocial2023].<!-- NvD: I suggest keeping this -->
...
when striving to make theory accessible, <!-- NvD: I suggest keeping this -->
it is important to be as explicit as possible (e.g., about assumptions  and ontological definitions), <!-- NvD: I suggest keeping this -->
while acknowledging that accessibility exists on a spectrum, <!-- NvD: I suggest keeping this -->
and that it is impossible to eliminate all ambiguity.<!-- NvD: I suggest keeping this -->
Rather, it may benefit scientific discourse to anticipate misunderstanding,<!-- NvD: I suggest keeping this -->
and use it to drive further explication of theory.<!-- NvD: I suggest keeping this -->
...
and cross-references to resources that provide relevant context (papers, ontologies, macro-theories, theories of measurement)<!-- NvD: I suggest keeping this -->
will advance its Accessibility.<!-- NvD: I suggest keeping this -->
...
FAIR principles also facilitate new ways of collaboration,
...
The `theorytools` R-package mitigates this limitation to some extent by automating key steps in the process. <!-- NvD: However, some skill with R is still required. -->
Moreover, the initial investment in time can be offset by long-term productivity gains and an increased impact of FAIR theory.
...
and we are developing open educational materials on theory development.

A limitation of scope is that FAIR theory does not directly resolve problems related to strategic ambiguity [REF] and lack of theory formalization [REF].
...
Another limitation of scope is that FAIR theory does not resolve other related issues in social sciences, such as the measurement crisis [REF] and lack of standardized ontologies for psychological constructs [REF].<!-- NvD: Adding this might go a bit too far, we are also not solving world hunger and poverty ;-) -->
...
Aside from the aforementioned "theory crisis", there has been talk of a "measurement crisis":  <!--AB very important point that I was already missing in the introduction; seems we also need FAIR measurements :) --> <!-- NvD: I agree. Also, if we mention it here, we should definitely not mention it under limitations ->
...
FAIR theory is a major step forward. A step towards more transparent, collaborative, and efficient theory construction.
