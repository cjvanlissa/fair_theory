...
The present paper introduces open science methods for theory specification.
...
We do so by implementing theories as information artifacts compliant with the FAIR principles.
The resulting FAIR theories are archived with apropriate metadata in a FAIR-compliant repository (e.g., Zenodo). 
...
formal theories facilitate inconsistency.
...
Another limitation of scope is that FAIR theory does not resolve other related issues in social sciences, such as the measurement crisis [@bringmannBackBasicsImportance2022] and lack of standardized ontologies for psychological constructs [@boscoMetaBUSVehicleFacilitating2017].
