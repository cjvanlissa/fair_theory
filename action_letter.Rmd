...
There are already two worked examples for actual theories in the package vignettes,
which we now reference in the text.
...
We believe our contribution will be most effective if it remains sharply focused on the practical infrastructure and its scientific use cases.
