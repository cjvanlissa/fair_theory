...
It is our hope that FAIR theory will be accepted by the community for the same reasons FAIR principles are increasingly adopted for various other digital objects, first and foremost, research data but lately also administrative data, workflows, or code.
...
We respectfully disagree; open data - one example of modular publishing - has increased dramatically in recent decades, up from ~7% of articles in 2000–2009 to ~50% of psychological articles in 2010-2019, and more (~80%) in other disciplines.
