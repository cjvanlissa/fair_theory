...
To address this comment, in the Revision, we repeatedly refer to the *potential* impact of FAIR theory, thus making it clear that we do not assume that this impact will be automatic nor guaranteed. Furthermore, we acknowledge in the Limitations section that empirical evidence for these potential benefits remains to be evaluated:
