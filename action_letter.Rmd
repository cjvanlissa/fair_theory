...
As methodologists, our focus in this paper is on "procedures", rather than policies or documentation. Our goal is to position FAIR theory as a communication protocol: a set of standards, grounded in philosophy of science and implemented in existing infrastructure, that facilitates theory specification, reuse, and collaborative refinement.
...
Compare FAIR theory to preregistration: it, too, was introduced first as a good idea; now - a decade later - empirical studies are being conducted to investigate its effects.
...
We thank the Reviewer for their thoughtful review and detailed comments. We have sought to address all comments, and feel that doing so has improved the quality of the manuscript.
...
Thank you for this suggestion; as proposed, we now briefly mention the R-package in the abstract:
...
nakagawaPoorHypothesesResearch2024
...
We removed the "cf.", although we couldn't find mention of it in the APA7 style guide. We updated the citation scheme to APA7, so three or more authors will be shortened to "et al.".
...
We respectfully disagree; open data - one example of modular publishing - has increased dramatically in recent decades, up from ~7% of articles in 2000–2009 to ~50% of articles in 2010-2019.
...
on behalf of all co-authors, I would like to express our sincere appreciation for your thoughtful comments. This is my (Caspar's) favorite review to date, and I especially value your perspective as a seasoned scholar/theoretician. All authors unanimously agreed that it would be a pity to deprive our readers of an opportunity to view FAIR theory through the lens of your lived experience - but we were not sure how to incorporate it. One author proposed to invite you as a co-author, others were concerned that this might constitute a conflict of interest.

We took the initiative to draft a paragraph that summarizes your comments on FAIR theory from the review, and mention your contribution in the Acknowledgements. We would be equally happy to credit your contribution with a co-authorship, depending on your - and the Editor's - preferences.
...
We think that this comment signals a need to better explain the important distinctions between these two practices.
...
To address this comment, we have removed as much of the specific detail as possible from the main text, and instead refer to the package vignettes (we have created an additional vignette to make this change possible, and extended several other vignettes).
We also already have two worked examples for actual theories, which we now point out in the text (with links to the relevant vignettes).
...
While we are completely sympathetic with the Reviewer's considerations about the roles of norms and values,
we are not sure that we are best positioned to engage with these issues, nor that the present paper would be the best place for such an argument.
While incentives are briefly mentioned in the paper, our focus as methodologists is on the "affordances" of FAIR theory: what types of academic work does FAIR theory make possible, and what problems could it solve.
We believe that meta-scientists and sociologists of science would be better positioned to engage with the topics of norms and values,
and that such a topic would be better suited to an empirical enquiry (i.e., establishing what the most widely held norms and values are, and how these relate to endorsements of academic practices).
