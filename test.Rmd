...
We propose a practical, software-agnostic workflow for making theory FAIR.
...
Begin by expressing the theory as a structured information artifact.
...
Implementing the theory as an information artifact can be as simple as isolating these statements from the paper,
...
we can save it to a plain text file - this is the "information artifact" containing our theory.
