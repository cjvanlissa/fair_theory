...
```{r figgithub, out.width = "50%", fig.show='hold', fig.cap='FAIR Theories on GitHub', fig.subcap=c('Different versions of a theory archived as distinct branches', 'These versions can be explicitly compared'), fig.ncol = 2}
#par(mfrow=c(1,2))
