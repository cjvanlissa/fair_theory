...
<!-- Hier iets over mijn interpretatie -->
...
This label invites the question of exactly *how* knowledge accumulates upon evaluation of a prior experiment.
...
In this specification, `theory` can be understood as FAIR theory.
...
Similarly, if we accept that observation is theory-laden, then it too involves induction [@brewerTheoryLadennessObservationTheoryLadenness2001].
Similarly, if the testing procedure is not explicitly defined before seeing the data, it incurs some inductive bias as well [@peikertTransparencyOpenScience2023].
