...
This is a preprint paper, generated from Git Commit \# eed54ad2.
...
Git tracks the internal provenance of a theory repository; Zenodo is used to archive relations to external references (e.g., papers that influenced the theory, previous theories that inspired it, models based upon the theory).
...
Aside from technical solutions to However, ``{[}i{]}n systems with many dependencies, releasing new {[}\ldots{]} versions can quickly become a nightmare.''
