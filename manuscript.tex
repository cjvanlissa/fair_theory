...
This is a preprint paper, generated from Git Commit \# 09ba7dc6.
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{ec_groot} \includegraphics[width=0.33\linewidth]{ec_wagenmakers} \includegraphics[width=0.33\linewidth]{ec_lissa} \caption{The empirical cycle according to De Groot (left), Wagenmakers and colleagues (center), and Van Lissa (right)}(\#fig:figecs, figures-side)
\end{figure}
...
\bibitem[\citeproctext]{ref-langeChecklist2025}
