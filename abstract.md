Open science innovations have focused on rigorous *theory testing*,
yet methods for specifying, sharing, and iteratively improving theories remain underdeveloped.
To address this limitation, we introduce *FAIR theory*:
A standard for specifying theories as Findable, Accessible, Interoperable, and Reusable digital objects.
FAIR theories are Findable in well-established archives,
Accessible in terms of availability and ability to be understood,
...
[We present a conceptual workflow for FAIRifying theory that builds on existing open science principles and infrastructures.
